...
session_start();
include_once('../abc_school/include/config.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script src="../abc_school/js/nav.js"></script>
    <script src="../abc_school/js/read_more.js"></script>
    <title>ABC</title>
</head>
<body onLoad="run_first()">
<?php include("../abc_school/include/banner.inc") ?>
<?php include("../abc_school/include/nav.inc") ?>
<?php
...
?>
<?php include("../abc_school/include/footer.inc") ?>
</body>
</html>
