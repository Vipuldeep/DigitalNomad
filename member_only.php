...
<body onLoad="run_first()">
    ...
    <div class="container-fluid">
		...
		?>
             <?php if(isset($name)): ?>
         <div>
            <h2 class="py-3 ml-2">Welcome <b><?php echo $name ?></b></h2>
...
<div class="col-md-4">
    <figure class="card card-product">
        ...
        <div class="bottom-wrap">
            <a href="payement.php" class="btn btn-sm btn-primary float-right">Book now!</a> 
    ...
    <form action="newsletter_process.php" method="post">
      <div class="row">
        ...
        <p>You are not logged in.</p>
         <p><a href="login.php" id="4" onClick="nav_item_selected(4)">Login</a></p>
        <?php endif; ?> 
